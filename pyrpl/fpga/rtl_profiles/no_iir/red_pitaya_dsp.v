...
// Keep slot 4 inactive so all later module addresses remain ABI-compatible.
assign output_direct[IIR] = 14'd0;
assign output_signal[IIR] = 14'd0;
assign module_ack[IIR] = sys_en;
assign module_rdata[IIR] = 32'd0;
