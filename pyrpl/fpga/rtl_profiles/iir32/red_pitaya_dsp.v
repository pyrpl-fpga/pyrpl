...
// Keep PID slot 2 inactive so trigger, IIR, and IQ addresses do not move.
assign output_direct[PID2] = 14'd0;
assign output_signal[PID2] = 14'd0;
assign diff_output_signal[PID2] = 14'd0;
assign module_ack[PID2] = sys_en;
assign module_rdata[PID2] = 32'd0;
