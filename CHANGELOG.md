...
- extend automatic Red Pitaya discovery to multiple network adapters and
  STEMlab OS 0.98
- improve the documentation hosted on [pyrpl.org](https://www.pyrpl.org) and
  provide a [video tutorial](https://www.youtube.com/watch?v=WnFkz1adhgs)
- automatically generate Windows, Linux, and macOS binaries for releases and
  publish them on [SourceForge](https://sourceforge.net/projects/pyrpl/files/)
